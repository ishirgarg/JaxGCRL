#!/bin/bash
#SBATCH --job-name=pm1g_emp_sweep_normal
...
# Sweep slice 34..50 of the 51-run pointmaze-1g sweep on rail_gpu4_normal.
# Companion script covers slice 0..33 (high). Split is proportional to
# concurrent capacity (16 high : 8 normal = 2:1).
# See rail_slurm_pointmaze_1g_emp_alpha_temp_sweep_high.sh for the index decoding.
