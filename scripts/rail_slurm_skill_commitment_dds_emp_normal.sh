#!/bin/bash
#SBATCH --job-name=skill_k_ddsemp_normal
...
#     high   : OFFSET=0  --array=0-15  -> CFG_IDX 0..15  (16 runs)
#     normal : OFFSET=16 --array=0-7   -> CFG_IDX 16..23 ( 8 runs, this file)
# This file is the NORMAL tier.
#
...
#
# Index decoding:
#   CFG_IDX  = OFFSET + SLURM_ARRAY_TASK_ID   (16..23 for this normal tier)
#   K_IDX    = CFG_IDX % 3                     (0..2)
