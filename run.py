...
def main(config: Config):
    ...
    metrics_to_collect = [
        ...
        "training/logits_neg",
        "training/logsumexp",
        "training/exploration_q_critic_loss",
        "training/bonus_total_mean",
        "training/bonus_raw_total_mean",
        "training/bonus_0_empowerment_empowerment_raw_mean",
        "training/bonus_0_empowerment_empowerment_shifted_mean",
        "training/bonus_1_empowerment_empowerment_raw_mean",
        "training/bonus_1_empowerment_empowerment_shifted_mean",
        "training/bonus_0_max_empowerment_max_empowerment_raw_mean",
        "training/bonus_0_max_empowerment_max_empowerment_shifted_mean",
        "training/bonus_1_max_empowerment_max_empowerment_raw_mean",
        "training/bonus_1_max_empowerment_max_empowerment_shifted_mean",
        "training/bonus_0_rnd_rnd_loss",
        "training/bonus_0_rnd_rnd_raw_bonus_mean",
        "training/bonus_0_rnd_rnd_bonus_mean",
        "training/bonus_0_rnd_rnd_reward_std",
        "training/bonus_1_rnd_rnd_loss",
        "training/bonus_1_rnd_rnd_raw_bonus_mean",
        "training/bonus_1_rnd_rnd_bonus_mean",
        "training/bonus_1_rnd_rnd_reward_std",
