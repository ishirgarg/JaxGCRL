...
def main(config: Config):
    ...
    metrics_to_collect = [
        ...
        "ep_eval/episode_dist",
        "ep_eval/episode_reward",
        "ep_eval/episode_reward_ctrl",
        "ep_eval/episode_reward_dist",
        "ep_eval/episode_reward_near",
        "ep_eval/episode_reward_survive",
        "ep_eval/episode_success",
        "ep_eval/episode_success_any",
        "ep_eval/episode_success_easy",
        "ep_eval/episode_success_hard",
        "training/actor_loss",
        "training/log_alpha",
        "training/alpha_loss",
