...
from jaxgcrl.agents import CRL, DADS, DIAYN, FlowSAC, PPO, SAC, TD3

from .env import legal_envs

# agent configurations
AgentConfig = Union[CRL, DADS, DIAYN, FlowSAC, PPO, SAC, TD3]
...
class RunConfig:
    ...
    exp_name: str = "run"
    log_wandb: bool = True
    wandb_project_name: str = "goal_proposers"
    wandb_group: str = "."
